...
exec_directory = artifacts

# path to the project file relative to project_dir
project_file = 

# application icon
icon = assets/QMemory.icns
...
extra_args = --quiet --noinclude-qt-translations --nofollow-import-to=tkinter,unittest --include-package=qmemory
